...
//         layout::{ConfigResource, GraphState, LayoutPlugin, LayoutResource},
//         layout_trait::{DebugLayout, Layout},
//         ui::UIPlugin,
//     },
// };
//
...
// pub struct LayoutResource2(Box<dyn VisualLayoutAlgorithm>);
// impl From<Box<dyn VisualLayoutAlgorithm>> for LayoutResource2 {
...
//         .insert_non_send_resource(LayoutResource2::from(layout))
...
//     mut layout: NonSendMut<LayoutResource2>,
//     config: Res<LayoutConfigResource>,
// ) {
...
// }
//
// fn iterate_layout(mut layout: NonSendMut<LayoutResource2>) {
//     layout.iterate()
// }
//
// fn update_destinations(
//     layout: NonSend<LayoutResource2>,
