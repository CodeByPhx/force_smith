use crate::layout::types::{GraphTransformationFn, PositionUpdateFn};
...
pub struct SomeGraphTransformationFn<Vertex, Edge>(pub GraphTransformationFn<Vertex, Edge>);
impl<Vertex, Edge> From<GraphTransformationFn<Vertex, Edge>>
