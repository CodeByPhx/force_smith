...
impl Parameterized for Config {
    fn get_parameters(&self) -> Vec<force_smith::visualizer2::layout_trait::Parameter> {
        Vec::new()
    }

    fn update_parameters(
        &mut self,
        _parameters: &[force_smith::visualizer2::layout_trait::Parameter],
    ) {
    }
}
